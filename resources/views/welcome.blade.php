    ...
    <div class="flex items-center justify-center w-full transition-opacity opacity-100 duration-750 lg:grow starting:opacity-0">
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            ...
            <div class="mb-6 relative">
                ...
                <input type="checkbox" id="alert-close" class="peer hidden">

                <div class="peer-checked:hidden rounded-lg border border-green-200 bg-green-50 p-4 text-green-800 shadow-sm">
                    <div class="flex items-start justify-between gap-4">
                        ...
                        <label for="alert-close"
                            class="cursor-pointer text-green-600 hover:text-green-800 transition">
